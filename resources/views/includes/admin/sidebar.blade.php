...
<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0 sidebar">
  ...
  <img src="{{ asset('img/logo3.png')}}" alt=""
    ...
    <a class="ml-3 text-lg font-bold text-blue-800 dark:text-blue-200" href="/">
    </a>
    <ul class="mt-6">
...
<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden sidebar"
